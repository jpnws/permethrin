  ...
  return (
    <aside className="flex flex-col">
      <div className="flex items-center gap-x-2 px-4 py-4">
        <svg className="block" width={16} height={16} xmlns="http://www.w3.org/2000/svg" fill="currentColor">
        ...
        <div className="text-sm font-semibold">Permethrin</div>
      </div>
      <div className="px-4">
        <Link href="/projects" className="flex items-center gap-x-2 rounded px-2 py-1 hover:bg-gray-100">
          <svg className="block" width={16} height={16} xmlns="http://www.w3.org/2000/svg" fill="currentColor">
